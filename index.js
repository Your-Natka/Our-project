import"./assets/rolldown-runtime-BDqkOrsv.js";import{n as e,t}from"./assets/quote-b8ipOzIe.js";import{t as n}from"./assets/vendor-BQcEvRoX.js";n();async function r(t,n=1,r=12){return e(`/filters?filter=${encodeURIComponent(t)}&page=${n}&limit=${r}`)}function i(e,t){t.innerHTML=e.map(({name:e,filter:t,imgURL:n})=>`
